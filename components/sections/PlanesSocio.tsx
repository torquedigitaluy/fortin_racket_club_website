...
type Plan = {
  ...
  precio: number;
  destacado?: boolean;
  // Una entrada por feature (en el mismo orden que FEATURES).
  incluye: boolean[];
};
...
const PLANES: Plan[] = [
  {
    nombre: "Principiante",
    precio: 29,
    incluye: [true, true, false, false, false],
  },
  {
    nombre: "Avanzado",
    precio: 59,
    incluye: [true, true, true, false, false],
  },
  {
    nombre: "Profesional",
    precio: 90,
    incluye: [true, true, true, true, false],
  },
  {
    nombre: "Full",
    precio: 120,
    destacado: true,
    incluye: [true, true, true, true, true],
  },
];

export default function PlanesSocio() {
  const [loading, setLoading] = useState<string | null>(null);
  const [aviso, setAviso] = useState<string | null>(null);

  async function comprar(plan: Plan) {
    setAviso(null);
